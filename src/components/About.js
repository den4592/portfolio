        ...
        <div className="about-wrapper">
            <div className="about-container">
                <div className="about-main-text">
                    <h1 style={{fontSize:'3rem', fontWeight:'500', textAlign:'center', color:'white',paddingBottom:'3rem'}}>About
                    ...
                    <div className="about-personal-details" >
                        ...
                        <div className="personal-details">
                            <h1 style={{color:'white',marginBottom:'2rem',textAlign:'center'}}>Personal Details</h1>
                            <p><i className="fas fa-chevron-right"></i><span>Junior Web Developer</span> Status</p>
                            <p><i className="fas fa-chevron-right"></i><span>중앙대학교(컴퓨터공학부)</span> Education</p>
                            <p><i className="fas fa-chevron-right"></i><span> 1997.11.02</span> Date of Birth</p>
